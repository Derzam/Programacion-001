...
public class DeberVectores {
	...
	public static void main(String[] args) {
		...
		//4.Declarar un vector B(10), a la posición B[0] asignele el valor 
		...
		//6.Declara un vector M(10) y asignar a todas sus posiciones valores impares que inician desde 1 y son secuenciales.
		...
		N[0]=7;
		N[4]=25;
		//N[12]=105; Fuera de rango del vector
		//N[20]=12; Fuera del rango del vector
		N[11]=5;
